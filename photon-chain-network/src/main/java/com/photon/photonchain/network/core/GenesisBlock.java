...
public class GenesisBlock {
    ...
    public static final byte[] GENESIS_PUBLIC_KEY = {4, -52, -95, -11, 1, -73, 35, 123, -95, 67, -76, 41, 38, 43, -92, -36, 120, -93, -82, 71, -1, -71, -78, -28, -94, -110, 48, 81, 106, -116, -76, 57, 82, -1, 1, -49, -87, 1, -16, 32, 112, 121, -73, 31, 67, 65, 95, 98, 116, -77, -115, -28, -70, -58, -122, -25, -81, 67, 36, 81, -74, 97, -12, 17, -44};
//    public static final byte[] ACCEPTER = {4, -49, 107, -53, -84, 75, 18, -36, -48, 9, 81, -5, 41, -104, -25, -23, -24, 65, 10, 24, -128, 124, 117, 37, -53, -100, -118, -38, -31, -34, 61, -127, 102, 124, -116, 76, 47, -26, 27, 94, -88, 20, -6, 9, 113, 60, 26, 12, -96, 51, -114, 54, 118, 98, 92, -72, -109, 124, 36, -50, -58, -107, -66, 83, -76};
    ...
    public static final byte[] ACCEPTER=Hex.decode("04716aaf5098d656b54413c3a3a4686500eb123123ad5752b6b2b1f13ab674f4274250cb55a8393ce789be12dbb6b0d43136515102f2eff819194dc164ea7f9ad6");
    private static final String HASH_PREV_BLOCK = "aced000570";
    public static final long RECEIVE_QUANTITY = 650000000L * Constants.MININUMUNIT;
...
//        }
        ...
        if (blockRepository.count() == 0) {
            ...
            TransactionHead transactionHead = new TransactionHead(Hex.toHexString(GENESIS_PUBLIC_KEY), Hex.toHexString(ACCEPTER), RECEIVE_QUANTITY, 0, GENESIS_TIME);
            BlockHead blockHead = new BlockHead(Constants.BLOCK_VERSION, GENESIS_TIME, Constants.CUMULATIVE_DIFFICULTY, Hex.decode(HASH_PREV_BLOCK), Hex.decode(HASH_MERKLE_ROOT));
            Transaction transaction = new Transaction(Hex.decode(TRANS_SIGNATURE), transactionHead, 1, 0, Hex.toHexString(GENESIS_PUBLIC_KEY), Hex.toHexString(ACCEPTER), "", Constants.PTN, 1, RECEIVE_QUANTITY, 0);
            List<Transaction> transactionList = new ArrayList<>();
            transactionList.add(transaction);
            Block block = new Block(1, 441, RECEIVE_QUANTITY, 0, Hex.decode(BLOCK_SIGNATURE), GENESIS_PUBLIC_KEY, blockHead, transactionList);
            block.setBlockHash(Hex.toHexString(SHAEncrypt.SHA256(blockHead)));
