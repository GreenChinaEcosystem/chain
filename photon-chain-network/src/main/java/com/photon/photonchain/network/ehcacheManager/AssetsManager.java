...
public class AssetsManager {
    ...
    public Map<String, Long> getAccountAssets(String pubKey, String tokenName) {
        ...
        try {
            ...
            TotalTrans tt=settlementManager.getCalculation(pubKey,tokenName);
            if(tt==null) {
                ...
                transIncome = tt.getIncome();
                transExpenditure = tt.getExpenditure()+tt.getFee();
            }
...
//        resultMap.put ( Constants.TOTAL_INCOME+".cache", account.get ( Constants.TOTAL_INCOME ) + tt.getIncome()+untransIncome );
...
//        resultMap.put ( Constants.TOTAL_EXPENDITURE+".cache", account.get ( Constants.TOTAL_EXPENDITURE ) +  tt.getExpenditure()+tt.getFee()+untransExpenditure );
