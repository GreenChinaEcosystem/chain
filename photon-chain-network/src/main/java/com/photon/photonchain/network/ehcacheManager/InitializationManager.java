...
//    public InesvMessage.Message.Builder getLastBlockMessage(){
//        return EhCacheManager.getCacheValue ( initializationCache, LAST_BLOCK+"_MESSAGE",  InesvMessage.Message.Builder.class );
//    }
//    public void setLastBlockMessage(InesvMessage.Message.Builder builder){
//        EhCacheManager.put ( initializationCache, LAST_BLOCK+"_MESSAGE", builder);
//    }
