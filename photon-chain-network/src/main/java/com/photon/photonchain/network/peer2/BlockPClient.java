...
@Component
public class BlockPClient {
    private Logger logger = LoggerFactory.getLogger(BlockPClient.class);

    @Autowired
    private PeerClientExcutor peerClientExcutor;

    @Autowired
    private BlockPClientInitializer peerClientInitializer;
    ...
    private final Integer PORT = 2906;
