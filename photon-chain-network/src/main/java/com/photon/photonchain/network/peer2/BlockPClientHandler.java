...
@Component
public class BlockPClientHandler extends SimpleChannelInboundHandler<InesvMessage.Message> {

    private static Logger logger = LoggerFactory.getLogger(BlockPClientHandler.class);
...
//        logger.info ( "接收消息..." );
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        InesvMessage.Message.Builder builder = MessageManager.createMessageBuilder(RESPONSE, PUSH_MAC2);
