...
@Component
public class BlockPServerInitializer extends ChannelInitializer<NioSocketChannel> {

    @Autowired
    private BlockPServerHandler peerServerHandler;

    Logger logger = LoggerFactory.getLogger(BlockPServerInitializer.class);

    @Override
    protected void initChannel(NioSocketChannel ch) throws Exception {
        logger.info("block 入口2");
