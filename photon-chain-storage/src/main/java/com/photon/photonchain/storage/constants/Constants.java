...
public class Constants {
    ...
    public static final BigInteger CUMULATIVE_DIFFICULTY = BigInteger.ONE;
    ...
    public static final Long MAX_PTN_AMOUNT = 650000000L;
    ...
    public static final int SYNC_WAIT_COUNT = 2;
    public static final int ACTIVE_NODE_COUNT = 2;
    public static final long GENESIS_TIME = 1604559940742L;// 1514736000000L;
    public static String serialNumber[] = {"A", "B", "C", "D", "E", "F", "G", "H", "I", "J"};
    public static boolean IS_SERVER = true;
    //交易签名MD5长度，32+
    public static int TRANS_SIGN_LENGTH = 66;
}
